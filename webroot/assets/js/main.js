...
function do_task(task) {
  ...
  //     alert(previous_path)
    ...
    function enable_transcribe() {
      //alert("Transcribe The File");
      $(".transcribe").css("height", "40px");
      $(".transcribe").css("opacity", "1");
      $(".list").css("height", `calc(100vh - 120px - 100px )`);
    }

    function  disable_transcribe() {
      $(".transcribe").css("height", "0px");
      $(".transcribe").css("opacity", "0");
      $(".list").css("height", `calc(100vh - 120px - 60px)`);
      //   alert('disable transcribe')
    }
