...
<body>
  ...
  <div class="body">
    <div class="path">
      ...
      <div class="task_header_item">
        ...
        <div class="_home gainFocus" tabindex="0" onclick="re_reload('../../..//trans/files')"  onkeypress="re_reload('../../..//trans/files')">
      ...
      <div class="_switching">
        <div class="switch_text">
          ...
          <span style="display:inline"> Click File to OPEN in Editor OR Activate Tools Menu With Toggle --&gt;  :  </span>
  ...
  <div class="task_footer">
    ...
    <div class="transcribe" onclick="do_task('transcribe')">
      Transcribe File
    </div>
  </div>
  <div class="file_task">
